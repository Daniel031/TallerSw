    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="formulario">
                <h2 class="mb-4 text-center">Crear Publicacion de Donaciones</h2>
                <form action="{{ route('store-publicacion') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="contribucion" name="contribucion" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <img id="foto2_preview" class="preview-img" src="#" alt="Preview Image" @required(true)>
                    </div>
