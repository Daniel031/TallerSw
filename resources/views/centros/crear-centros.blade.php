    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="formulario">
                <h2 class="mb-4 text-center">Crear Centro</h2>
                <form action="{{ route('store-centro') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <img id="foto1_preview" class="preview-img" src="#" alt="Preview Image" @required(true)>
                        </div>
                        <div class="form-group col-md-6">
